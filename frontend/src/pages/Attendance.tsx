...
import {
  ...
  CalendarDays, Download, LogIn, LogOut
} from 'lucide-react';
              ...
              <div className="flex gap-2">
                {!todayCheckIn ? (
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-white text-primary-700 rounded-xl font-semibold text-sm hover:bg-primary-50 transition-colors"
                  >
