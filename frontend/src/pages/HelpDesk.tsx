  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          ...
          filtered.map(ticket => {
            ...
            return (
              <div key={ticket.id} className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-lg hover:shadow-gray-100/50 transition-all">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        {ticket.status !== 'resolved' && ticket.status !== 'closed' && (
                          <Button size="sm" variant="secondary" onClick={() => handleResolve(ticket.id)}>
                            Resolve
                          </Button>
                        )}
                      </div>
      ...
      <Modal
        ...
        subtitle="Submit your HR query or request"
        footer={
          <>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormSelect
              ...
              onChange={(v) => setFormData({ ...formData, priority: v as HelpDeskTicket['priority'] })}
              options={[
                { value: 'low', label: 'Low' },
