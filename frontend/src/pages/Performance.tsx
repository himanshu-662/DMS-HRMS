...
export default function Performance() {
  ...
  const handleUpdateProgress = (reviewId: string, goalId: string, progress: number) => {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100">
          ...
          {activeTab === 'goals' && (
            <div className="p-5 space-y-4 max-h-[500px] overflow-y-auto">
              {allGoals.map(goal => (
                <div key={goal.id} className="border border-gray-100 rounded-xl p-4 hover:shadow-md transition-all">
                  ...
                  <div className="mt-3">
                    ...
                    <input
                      ...
                      className="w-full h-2 bg-gray-100 rounded-full appearance-none cursor-pointer accent-primary-600"
                    />
      ...
      <Modal
        ...
        subtitle={review?.reviewPeriod}
        size="lg"
        footer={<Button onClick={() => setSelectedReview(null)}>Close</Button>}
      >
        {review && (
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    {[1, 2, 3, 4, 5].map(star => (
                      <Star
                        ...
                        className={cn(
                          'w-5 h-5',
                          star <= Math.floor(review.rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-200'
                        )}
                      />
                    ))}
            ...
            <div>
              ...
              <div className="space-y-3">
                {review.goals.map(goal => (
                  <div key={goal.id} className="p-3 rounded-xl bg-gray-50">
