...
export default function ConfirmDialog({ isOpen, onClose, onConfirm, title, message, type = 'danger', confirmText = 'Confirm', cancelText = 'Cancel', }) {
    const icons = {
        danger: Trash2,
    ...
    return (<Modal isOpen={isOpen} onClose={onClose} title="" size="sm">
