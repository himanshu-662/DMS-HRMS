...
export default function Login({ onGoToSignup }: LoginProps) {
  ...
  return (
    <div className={cn('min-h-screen flex items-center justify-center p-4 transition-colors duration-500', state.darkMode ? 'dark bg-gray-900' : 'bg-gradient-to-br from-primary-600 via-primary-700 to-violet-800')}>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-gray-50 dark:bg-gray-900/30 rounded-2xl text-sm border-2 border-transparent focus:border-primary-500 focus:bg-white dark:focus:bg-gray-700 transition-all outline-none"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3.5 bg-gray-50 dark:bg-gray-900/30 rounded-2xl text-sm border-2 border-transparent focus:border-primary-500 focus:bg-white dark:focus:bg-gray-700 transition-all outline-none"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-primary-600 hover:bg-primary-700 text-white text-sm font-bold rounded-2xl transition-all shadow-xl shadow-primary-600/30 flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-50"
            >
              {isLoading ? (
