    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {reportCards.map(report => (
          <div key={report.title} className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-lg hover:shadow-gray-100/50 transition-all group cursor-pointer">
            <div className="flex items-start justify-between mb-3">
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-primary-600 bg-primary-50 rounded-lg hover:bg-primary-100"
              >
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5">
          ...
          <ResponsiveContainer width="100%" height={240}>
            <AreaChart data={monthlyAttendance}>
              ...
              <Tooltip contentStyle={{ borderRadius: 12, border: '1px solid #e5e7eb' }} formatter={(v: any) => [`${v}%`, 'Rate']} />
